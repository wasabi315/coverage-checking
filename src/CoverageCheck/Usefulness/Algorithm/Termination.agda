...
patternMatrixStackSize-++ : (P Q : PatternMatrixStack αss) → patternMatrixStackSize (P ++ Q) ≡ patternMatrixStackSize P + patternMatrixStackSize Q
...
specializeCon-⊏ : (P : PatternMatrixStack ((TyData d ∷ αs) ∷ αss))
  (c : NameCon d) (rs : Patterns (argsTy (dataDefs sig d) c)) (ps : Patterns αs) (pss : PatternStack αss)
